...
\begin{minipage}[t]{0.5\textwidth} % 50% of the page for the skills bar chart
	...
	\begin{itemize}[align=left, leftmargin=5em, itemindent=0pt, labelwidth=5em]
	...
	\cvsubsect{Skills}
	\begin{itemize}[align=left, leftmargin=5em, itemindent=0pt, labelwidth=5em]
		\item[\textbf{Expert:}] Full Stack Web Dev, Game Dev, Linux
		\item[\textbf{Proficient:}] Embedded Dev
		\item[\textbf{Comptent:}] Soldering, CAD, 3D Printing
...
\begin{minipage}[t]{0.5\textwidth} % 50% of the page for the skills bar chart
	...
	\begin{itemize}[align=left, leftmargin=5em, itemindent=0pt, labelwidth=5em]
		\item[\textbf{Expert:}] HTML/CSS, Node.js, PlatformIO, Arduino
		\item[\textbf{Proficient:}] ReactJS, Unity, SteamVR, GCP, Firebase, Azure
		\item[\textbf{Comptent:}] WebGL/OpenGL, Docker
	...
	\begin{itemize}[align=left, leftmargin=5em, itemindent=0pt, labelwidth=5em]
		...
		\item[\textbf{Proficient:}] Blender, Emacs, IntelliJ
		\item[\textbf{Comptent:}] Fusion 360, KiCad, Photoshop, Illustrator, Emacs
